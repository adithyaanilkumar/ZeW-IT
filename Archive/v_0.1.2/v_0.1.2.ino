#include <Servo.h>
Servo servolo;
const int b1,b2,b3,b4=2,b5,b6,b7,b8,b9,b10,b11,b12;
const int t=52,e=53,t1=50,e1=51,t2=48,e2=49,t3=46,e3=47,t4=44,e4=45,t5=42,e5=43;
const int led1,led2,ledre,ledplswait;
...
{ Serial.println("loop running");
 ...
 // here let w4 be the agricultural waste
  ...
  if(steprpos==0&&agri==1&&areyoudonestatus==1)
  {
    digitalWrite(ledplswait,HIGH);
    dc =dcmix();
    digitalWrite(ledplswait,LOW);
  }
  if (steprpos==0&&areyoudonestatus==1)
  {  digitalWrite(ledplswait,HIGH);
    int a=sensor();
